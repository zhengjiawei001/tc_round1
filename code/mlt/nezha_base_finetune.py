# -*- coding: utf-8 -*-
# @Time    : 2021/4/9 3:59 下午
# @Author  : zhengjiawei
# @FileName: nezha_base_finetune.py
# @Software: PyCharm
...
from .utils import seed_everyone, read_data, load_cv_data, train, predict, load_data
...
def main():
    config = {
        'overwrite': True,
        'data_path': '.',
        'data_cache_path': '../user_data/tmp_data/finetune_output/nezha_base_cv7_processed/data.pkl',
        'output_path': '../user_data/tmp_data/finetune_output/nezha_base_cv7_results',
        'model_path': '../user_data/tmp_data/pretrain_output/nezha_base_output/best_model_ckpt',
        'best_model_path': '',
        'batch_size': 64,
        'num_epochs': 3,
        'num_folds': 7,
    ...
    tokenizer = BertTokenizer.from_pretrained('../user_data/model_data/nezha-cn-base/vocab.txt')
